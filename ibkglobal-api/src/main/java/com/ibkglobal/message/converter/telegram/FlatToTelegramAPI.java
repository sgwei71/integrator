...
public class FlatToTelegramAPI extends FlatToTelegram{
	...
	private static Logger logger = LoggerFactory.getLogger(FlatToTelegramAPI.class);
	/**
	...
	public static StandardTelegram flatToTelegramAPI(byte[] message, List<Tlgr> fieldList) throws Exception {
		...
		while (buffer.position() < buffer.capacity()) {
			...
			buffer.get(headerCd);
			String headerCode = new String(headerCd);
			System.out.println("headerCd="+headerCode);			
