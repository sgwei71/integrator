...
public class ApiDefaultAdapterOutboundTemplate extends RouteCreateDefault{
	
	private Logger logger = LoggerFactory.getLogger(ApiDefaultAdapterOutboundTemplate.class);
	public ApiDefaultAdapterOutboundTemplate(RouteCreateInfo builderInfo) {
