...
import com.ibkglobal.integrator.engine.builder.route.RestRouteCreateDefault;

import lombok.Getter;
import lombok.Setter;

public class RestDefaultAdapterIn extends RestRouteCreateDefault{
	
	@Getter @Setter
	RestDefinition restDefinition;

	public RestDefaultAdapterIn(RouteCreateInfo builderInfo) {
